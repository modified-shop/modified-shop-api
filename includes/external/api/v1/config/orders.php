...
/* -----------------------------------------------------------------------------------------
  ...
  $app->delete('/orders/{id}/products',             \api\v1\Service\Order\DeleteProduct::class);
  $app->delete('/orders/{id}/products_attributes',  \api\v1\Service\Order\DeleteProductAttributes::class);
  $app->delete('/orders/{id}/products_download',    \api\v1\Service\Order\DeleteProductDownload::class);
  $app->delete('/orders/{id}/status_history',       \api\v1\Service\Order\DeleteStatusHistory::class);
  $app->delete('/orders/{id}/total',                \api\v1\Service\Order\DeleteTotal::class);
  $app->delete('/orders/{id}/tracking',             \api\v1\Service\Order\DeleteTracking::class);
