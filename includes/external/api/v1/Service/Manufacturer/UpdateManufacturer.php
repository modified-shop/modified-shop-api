...
/**
 * /includes/external/api/v1/Service/Manufacturer/UpdateManufacturer.php
 *
                ...
                properties: [
                    ...
                    new OA\Property(
                        ...
                        description: 'Per-language manufacturer text, keyed by language code (e.g. "de", "en"). '
                            ...
                            . 'via GET /api/v1/schema/manufacturers_info. Note: the manufacturer must already '
                            . 'have a manufacturers_info row for the request to succeed.'
                    )
                ]
            )
        )
