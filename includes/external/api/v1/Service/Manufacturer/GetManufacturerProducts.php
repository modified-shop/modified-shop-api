...
/**
 * /includes/external/api/v1/Service/Manufacturer/GetManufacturerProducts.php
 *
...
#[OA\Get(
    ...
    tags: ['Manufacturer'],
    summary: 'Get manufacturers products',
...
final class GetManufacturerProducts extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->manufacturerAction->GetManufacturerProducts($manufacturerId);
