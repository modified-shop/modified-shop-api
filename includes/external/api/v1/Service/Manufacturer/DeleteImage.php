...
/**
 * /includes/external/api/v1/Service/Manufacturer/DeleteImage.php
 *
...
#[OA\Delete(
    ...
    tags: ['Manufacturer'],
    summary: 'Delete image from a manufacturer',
    description: 'Delete image from a manufacturer by given Id',
...
final class DeleteImage extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->manufacturerAction->DeleteImage($manufacturerId);
