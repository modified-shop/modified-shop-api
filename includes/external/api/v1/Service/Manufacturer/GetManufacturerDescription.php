...
/**
 * /includes/external/api/v1/Service/Manufacturer/GetManufacturerDescription.php
 *
...
#[OA\Get(
    ...
    tags: ['Manufacturer'],
    description: 'Get manufacturers description by given Id',
    operationId: 'GetManufacturerDescription',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
    ...
    responses: [
        ...
        new OA\Response(
            response: 403,
            description: 'no manufacturers description found'
        ),
        new OA\Response(
            response: 500,
    ...
    security: [
        ['modified_auth' => ['GetManufacturerDescription']]
    ]
)]
