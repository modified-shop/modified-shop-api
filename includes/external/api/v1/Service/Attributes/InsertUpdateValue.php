...
/**
 * /includes/external/api/v1/Service/Attributes/InsertUpdateValue.php
 *
...
#[OA\Put(
    ...
    tags: ['Attributes'],
    summary: 'Update single attributes value',
    description: 'Update single attributes value by given Id',
    operationId: 'InsertUpdateAttributesValue',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
        ...
        content: new OA\MediaType(
            ...
            schema: new OA\Schema(
                ...
                description: 'Per-language value text, keyed by language code (e.g. "de", "en"). Each value is '
                    . 'an object of products_options_values columns. '
                    . 'Discover the exact columns via GET /api/v1/schema/products_options_values.'
            )
        )
    ),
    responses:[
