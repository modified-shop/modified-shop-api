...
/**
 * /includes/external/api/v1/Service/Attributes/GetAttributes.php
 *
...
#[OA\Get(
    ...
    tags: ['Attributes'],
    summary: 'Get attributes (values assigned to an option)',
    description: 'Get attributes (values assigned to an option) by given option Id',
