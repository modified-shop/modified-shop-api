...
/**
 * /includes/external/api/v1/Service/Attributes/DeleteAllAttributes.php
 *
...
#[OA\Delete(
    ...
    tags: ['Attributes'],
    summary: 'Delete all values from an option',
    description: 'Delete all values from an option by given Id',
...
final class DeleteAllAttributes extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->attributesAction->DeleteAllAttributes($optionId);
