...
/**
 * /includes/external/api/v1/Service/Configuration/GetConfiguration.php
 *
...
namespace api\v1\Service\Configuration;
  ...
  #[OA\Get(
    ...
    security: [
      ['modified_auth' => ['GetConfiguration']]
    ]
  )]
  
  final class GetConfiguration extends BaseService
  {
      /**
      ...
      public function __invoke(
          ...
          $result = $this->configurationAction->GetConfiguration($configurationGroupId);
