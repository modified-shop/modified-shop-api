...
/**
 * /includes/external/api/v1/Service/Product/GetProductReviews.php
 *
...
namespace api\v1\Service\Product;
  ...
  #[OA\Get(
    ...
    security: [
      ['modified_auth' => ['GetProductReviews']]
    ]
  )]
  
  final class GetProductReviews extends BaseService
  {
      /**
       * @var ProductAction
       */
      ...
      public function __invoke(
          ...
          $result = $this->productAction->GetProductReviews($productId);
