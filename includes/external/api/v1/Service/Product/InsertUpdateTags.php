...
/**
 * /includes/external/api/v1/Service/Product/InsertUpdateTags.php
 *
...
final class InsertUpdateTags extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->productAction->InsertUpdateTags($productId, $data);
