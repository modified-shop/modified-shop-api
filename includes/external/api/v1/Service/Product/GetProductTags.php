...
/**
 * /includes/external/api/v1/Service/Product/GetProductTags.php
 *
...
#[OA\Get(
    ...
    tags: ['Product'],
    summary: 'Get products tag data',
    description: 'Get products tag data by given Id',
    ...
    responses: [
        new OA\Response(
            response: 200,
            description: 'product tag data',
        ),
        new OA\Response(
            response: 403,
            description: 'no product tag found'
        ),
        new OA\Response(
            response: 500,
...
final class GetProductTags extends BaseService
{
    /**
     * @var ProductAction
     */
