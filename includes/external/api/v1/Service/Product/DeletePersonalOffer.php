...
#[OA\Delete(
    ...
    tags: ['Product'],
    summary: 'Delete single personal offer from a product',
    description: 'Delete single personal offer from a product by given Ids',
    ...
    responses:[
        ...
        new OA\Response(
            response: 403,
            description: 'product not found or customer status not found or price not found'
        ),
        new OA\Response(
            response: 500,
            description: 'product Id required or customer status Id required or price Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
