...
/**
 * /includes/external/api/v1/Service/Product/DeleteXsell.php
 *
...
#[OA\Delete(
    ...
    tags: ['Product'],
    summary: 'Delete single xsell from a product',
    ...
    responses:[
        ...
        new OA\Response(
            response: 403,
            description: 'product not found or xsell not found'
        ),
        new OA\Response(
            response: 500,
            description: 'product Id required or xsell Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
