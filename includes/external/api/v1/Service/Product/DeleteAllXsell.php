...
/**
 * /includes/external/api/v1/Service/Product/DeleteAllXsell.php
 *
...
#[OA\Delete(
    ...
    tags: ['Product'],
    summary: 'Delete all xsell from a product',
    description: 'Delete all xsell from a product by given Id',
    operationId: 'DeleteAllXsell',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
...
final class DeleteAllXsell extends BaseService
{
    /**
     * @var ProductAction
     */
