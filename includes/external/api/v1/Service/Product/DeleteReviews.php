...
/**
 * /includes/external/api/v1/Service/Product/DeleteReviews.php
 *
...
#[OA\Delete(
    ...
    responses:[
        ...
        new OA\Response(
            response: 403,
            description: 'product not found or review not found'
        ),
        new OA\Response(
            response: 500,
            description: 'product Id required or review Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
...
final class DeleteReviews extends BaseService
{
    /**
     * @var ProductAction
     */
