...
/**
 * /includes/external/api/v1/Service/Product/DeleteAllImages.php
 *
...
#[OA\Delete(
    ...
    security: [
        ['modified_auth' => ['DeleteAllImages']]
    ]
)]

final class DeleteAllImages extends BaseService
{
    /**
     * @var ProductAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->productAction->DeleteAllImages($productId);
