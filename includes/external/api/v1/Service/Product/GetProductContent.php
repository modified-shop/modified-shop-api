...
/**
 * /includes/external/api/v1/Service/Product/GetProductContent.php
 *
...
#[OA\Get(
    ...
    responses: [
        ...
        new OA\Response(
            response: 403,
            description: 'no product content found'
        ),
        new OA\Response(
            response: 500,
    ...
    security: [
        ['modified_auth' => ['GetProductContent']]
    ]
)]

final class GetProductContent extends BaseService
{
    /**
     * @var ProductAction
     */
