...
/**
 * /includes/external/api/v1/Service/Product/DeleteAttributes.php
 *
...
#[OA\Delete(
    ...
    tags: ['Product'],
    summary: 'Delete single attribute from a product',
    ...
    responses:[
        ...
        new OA\Response(
            response: 403,
            description: 'product not found or attribute not found'
        ),
        new OA\Response(
            response: 500,
            description: 'product Id required or attribute Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
