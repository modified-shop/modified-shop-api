...
/**
 * /includes/external/api/v1/Service/Product/DeleteCategory.php
 *
...
#[OA\Delete(
    ...
    tags: ['Product'],
    summary: 'Delete single category from a product',
    ...
    responses:[
        ...
        new OA\Response(
            response: 500,
            description: 'product Id required or category Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
