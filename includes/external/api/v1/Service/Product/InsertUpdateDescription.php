...
/**
 * /includes/external/api/v1/Service/Product/InsertUpdateDescription.php
 *
...
#[OA\Post(
    ...
    tags: ['Product'],
    summary: 'Insert products description',
    description: 'Insert products description by given Id',
    operationId: 'UpdateProductsDescription',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
...
#[OA\Put(
    ...
    description: 'Update products description by given Id',
    operationId: 'InsertProductsDescription',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
...
final class InsertUpdateDescription extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->productAction->InsertUpdateDescription($productId, $data);
