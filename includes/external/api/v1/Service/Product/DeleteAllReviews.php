...
/**
 * /includes/external/api/v1/Service/Product/DeleteAllReviews.php
 *
...
#[OA\Delete(
    ...
    tags: ['Product'],
    summary: 'Delete all reviews from a product',
    description: 'Delete all reviews from a product by given Id',
...
final class DeleteAllReviews extends BaseService
{
    /**
     * @var ProductAction
     */
