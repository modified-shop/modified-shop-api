...
/**
 * /includes/external/api/v1/Service/Product/DeleteAllPersonalOffers.php
 *
...
#[OA\Delete(
    ...
    security: [
        ['modified_auth' => ['DeleteAllPersonalOffers']]
    ]
)]

final class DeleteAllPersonalOffers extends BaseService
{
    /**
     * @var ProductAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->productAction->DeleteAllPersonalOffers($productId);
