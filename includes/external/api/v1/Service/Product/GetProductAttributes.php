...
/**
 * /includes/external/api/v1/Service/Product/GetProductAttributes.php
 *
...
#[OA\Get(
    ...
    tags: ['Product'],
    summary: 'Get products attributes data',
    description: 'Get products attributes data by given Id',
...
final class GetProductAttributes extends BaseService
{
    /**
     * @var ProductAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->productAction->GetProductAttributes($productId);
