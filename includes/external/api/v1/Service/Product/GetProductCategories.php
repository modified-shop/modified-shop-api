...
/**
 * /includes/external/api/v1/Service/Product/GetProductCategories.php
 *
...
#[OA\Get(
    ...
    tags: ['Product'],
    summary: 'Get products category data',
...
final class GetProductCategories extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->productAction->GetProductCategories($productId);
