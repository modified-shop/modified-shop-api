...
/**
 * /includes/external/api/v1/Service/Product/GetProductImages.php
 *
...
#[OA\Get(
    ...
    tags: ['Product'],
    summary: 'Get products images data',
    description: 'Get products images data by given Id',
...
final class GetProductImages extends BaseService
{
    /**
     * @var ProductAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->productAction->GetProductImages($productId);
