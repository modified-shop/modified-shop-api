...
/**
 * /includes/external/api/v1/Service/Order/DeleteTracking.php
 *
...
#[OA\Delete(
    ...
    tags: ['Order'],
    summary: 'Delete single order tracking',
    description: 'Delete single order tracking by given Id',
...
final class DeleteTracking extends BaseService
{
    /**
     * @var OrderAction
     */
