...
/**
 * /includes/external/api/v1/Service/Order/DeleteAllTracking.php
 *
...
namespace api\v1\Service\Order;
  ...
  #[OA\Delete(
    ...
    security: [
      ['modified_auth' => ['DeleteAllTracking']]
    ]
  )]

  final class DeleteAllTracking extends BaseService
  {
      /**
       * @var OrderAction
       */
      ...
      public function __invoke(
          ...
          $result = $this->orderAction->DeleteAllTracking($orderId);
