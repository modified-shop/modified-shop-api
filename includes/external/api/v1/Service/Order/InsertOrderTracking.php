...
/**
 * /includes/external/api/v1/Service/Order/InsertOrderTracking.php
 *
...
#[OA\Post(
    ...
    security: [
        ['modified_auth' => ['InsertOrderTracking']]
    ]
)]

final class InsertOrderTracking extends BaseService
{
    /**
     * @var OrderAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->orderAction->InsertOrderTracking($orderId, $data);
