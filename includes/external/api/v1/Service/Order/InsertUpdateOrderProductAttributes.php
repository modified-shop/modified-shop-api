...
/**
 * /includes/external/api/v1/Service/Order/InsertUpdateOrderProductAttributes.php
 *
...
#[OA\Put(
    ...
    tags: ['Order'],
    summary: 'Update order products attributes data',
    ...
    requestBody: new OA\RequestBody(
        ...
        content: new OA\MediaType(
            ...
            schema: new OA\Schema(
                type: 'object',
                description: 'Columns of the orders_products_attributes database table, sent flat. Discover '
                    . 'the exact set via GET /api/v1/schema/orders_products_attributes.'
            )
        )
    ),
    responses: [
