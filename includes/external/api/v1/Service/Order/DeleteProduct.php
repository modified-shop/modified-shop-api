...
/**
 * /includes/external/api/v1/Service/Order/DeleteProduct.php
 *
...
#[OA\Delete(
    ...
    tags: ['Order'],
    summary: 'Delete single order product',
    description: 'Delete single order product by given Id',
    operationId: 'DeleteProductOrders',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
...
final class DeleteProduct extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->orderAction->DeleteProduct($orderId, $orderProductsId);
