...
/**
 * /includes/external/api/v1/Service/Order/InsertUpdateOrderTracking.php
 *
...
#[OA\Put(
    ...
    tags: ['Order'],
    summary: 'Update order tracking data',
    ...
    requestBody: new OA\RequestBody(
        ...
        content: new OA\MediaType(
            ...
            schema: new OA\Schema(
                type: 'object',
                description: 'Columns of the orders_tracking database table, sent flat. Discover the exact set '
                    . 'via GET /api/v1/schema/orders_tracking.'
            )
        )
    ),
    responses: [
        ...
        new OA\Response(
            response: 403,
            description: 'order not found or order tracking not found'
        ),
        new OA\Response(
            response: 500,
            description: 'order Id required or order tracking Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
