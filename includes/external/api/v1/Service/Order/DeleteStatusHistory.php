...
#[OA\Delete(
    ...
    tags: ['Order'],
    summary: 'Delete single order status history entry',
    description: 'Delete single order status history entry by given Ids',
    ...
    responses:[
        ...
        new OA\Response(
            response: 500,
            description: 'order Id required or order histroy Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
