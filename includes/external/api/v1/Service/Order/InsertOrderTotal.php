...
/**
 * /includes/external/api/v1/Service/Order/InsertOrderTotal.php
 *
...
#[OA\Post(
    ...
    security: [
        ['modified_auth' => ['InsertOrderTotal']]
    ]
)]

final class InsertOrderTotal extends BaseService
{
    /**
     * @var OrderAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->orderAction->InsertOrderTotal($orderId, $data);
