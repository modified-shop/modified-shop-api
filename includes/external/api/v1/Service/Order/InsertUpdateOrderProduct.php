...
#[OA\Put(
    ...
    tags: ['Order'],
    summary: 'Update order products data',
    ...
    requestBody: new OA\RequestBody(
        ...
        content: new OA\MediaType(
            ...
            schema: new OA\Schema(
                type: 'object',
                description: 'Columns of the orders_products database table, sent flat. Discover the exact set '
                    . 'via GET /api/v1/schema/orders_products.'
            )
        )
    ),
    responses: [
        ...
        new OA\Response(
            response: 403,
            description: 'order not found or order products not found'
        ),
        new OA\Response(
            response: 500,
            description: 'order Id required or order products Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
