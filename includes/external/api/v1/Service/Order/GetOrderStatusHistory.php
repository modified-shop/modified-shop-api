...
/**
 * /includes/external/api/v1/Service/Order/GetOrderStatusHistory.php
 *
...
#[OA\Get(
    ...
    tags: ['Order'],
    summary: 'Get order status history data',
    description: 'Get order status history data by given Id',
    ...
    responses: [
        ...
        new OA\Response(
            response: 403,
            description: 'no order status history found'
        ),
        new OA\Response(
            response: 500,
...
final class GetOrderStatusHistory extends BaseService
{
    /**
     * @var OrderAction
     */
