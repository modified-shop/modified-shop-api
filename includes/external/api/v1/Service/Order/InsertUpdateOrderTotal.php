...
/**
 * /includes/external/api/v1/Service/Order/InsertUpdateOrderTotal.php
 *
...
#[OA\Put(
    ...
    tags: ['Order'],
    summary: 'Update order total data',
    ...
    responses: [
        ...
        new OA\Response(
            response: 403,
            description: 'order not found or order total not found'
        ),
        new OA\Response(
            response: 500,
            description: 'order Id required or order total Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
...
final class InsertUpdateOrderTotal extends BaseService
{
    /**
     * @var OrderAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->orderAction->InsertUpdateOrderTotal($orderId, $orderTotalId, $data);
