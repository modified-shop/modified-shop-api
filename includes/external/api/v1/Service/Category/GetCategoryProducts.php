...
/**
 * /includes/external/api/v1/Service/Category/GetCategoryProducts.php
 *
...
namespace api\v1\Service\Category;
  ...
  #[OA\Get(
    ...
    tags: ['Category'],
    description: 'Get categories products by given Id',
    ...
    responses: [
      ...
      new OA\Response(
        response: 403,
        description: 'no category products found'
      ),
      new OA\Response(
        response: 500,
    ...
    security: [
      ['modified_auth' => ['GetCategoryProducts']]
    ]
  )]
  
  final class GetCategoryProducts extends BaseService
  {
      /**
       * @var CategoryAction
       */
