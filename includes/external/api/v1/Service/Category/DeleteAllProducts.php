...
/**
 * /includes/external/api/v1/Service/Category/DeleteAllProducts.php
 *
...
#[OA\Delete(
    ...
    tags: ['Category'],
    summary: 'Delete all products from a category',
...
final class DeleteAllProducts extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->categoryAction->DeleteAllProducts($categoryId);
