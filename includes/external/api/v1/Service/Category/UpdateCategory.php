...
/**
 * /includes/external/api/v1/Service/Category/UpdateCategory.php
 *
...
namespace api\v1\Service\Category;
  ...
  #[OA\Put(
    ...
    tags: ['Category'],
    description: 'Update single category by given category Id',
    ...
    security: [
      ['modified_auth' => ['UpdateCategory']]
    ]
  )]

  final class UpdateCategory extends BaseService
  {
      /**
       * @var CategoryAction
       */
      ...
      public function __invoke(
          ...
          $result = $this->categoryAction->UpdateCategory($categoryId, $data);
