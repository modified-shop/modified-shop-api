...
/**
 * /includes/external/api/v1/Service/Customer/DeleteAllWishlist.php
 *
...
#[OA\Delete(
    ...
    security: [
        ['modified_auth' => ['DeleteAllWishlist']]
    ]
)]

final class DeleteAllWishlist extends BaseService
{
    /**
     * @var CustomerAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->customerAction->DeleteAllWishlist($customerId);
