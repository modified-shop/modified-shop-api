...
/**
 * /includes/external/api/v1/Service/Customer/GetCustomerBasket.php
 *
...
namespace api\v1\Service\Customer;
  ...
  #[OA\Get(
    ...
    responses: [
      ...
      new OA\Response(
        response: 403,
        description: 'no customer basket found'
      ),
      new OA\Response(
        response: 500,
    ...
    security: [
      ['modified_auth' => ['GetCustomerBasket']]
    ]
  )]
  
  final class GetCustomerBasket extends BaseService
  {
      /**
       * @var CustomerAction
       */
      ...
      public function __invoke(
          ...
          $result = $this->customerAction->GetCustomerBasket($customerId);
