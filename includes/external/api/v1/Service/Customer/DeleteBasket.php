...
/**
 * /includes/external/api/v1/Service/Customer/DeleteBasket.php
 *
...
#[OA\Delete(
    ...
    tags: ['Customer'],
    summary: 'Delete single customer basket',
...
final class DeleteBasket extends BaseService
{
    ...
    public function __invoke(
        ...
        $result = $this->customerAction->DeleteBasket($customerId, $customersBasketId);
