...
/**
 * /includes/external/api/v1/Service/Customer/DeleteAllBasket.php
 *
...
namespace api\v1\Service\Customer;
  ...
  #[OA\Delete(
    ...
    security: [
      ['modified_auth' => ['DeleteAllBasket']]
    ]
  )]

  final class DeleteAllBasket extends BaseService
  {
      /**
       * @var CustomerAction
       */
      ...
      public function __invoke(
          ...
          $result = $this->customerAction->DeleteAllBasket($customerId);
