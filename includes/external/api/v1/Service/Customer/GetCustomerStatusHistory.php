...
/**
 * /includes/external/api/v1/Service/Customer/GetCustomerStatusHistory.php
 *
...
namespace api\v1\Service\Customer;
  ...
  #[OA\Get(
    ...
    responses: [
      new OA\Response(
        response: 200, 
        description: 'customer status history data',
      ),
      new OA\Response(
        response: 403,
        description: 'no customer status history found'
      ),
      new OA\Response(
        response: 500,
    ...
    security: [
      ['modified_auth' => ['GetCustomerStatusHistory']]
    ]
  )]
  
  final class GetCustomerStatusHistory extends BaseService
  {
      /**
       * @var CustomerAction
       */
      ...
      public function __invoke(
          ...
          $result = $this->customerAction->GetCustomerStatusHistory($customerId);
