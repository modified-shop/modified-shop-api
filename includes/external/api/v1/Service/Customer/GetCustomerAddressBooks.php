...
/**
 * /includes/external/api/v1/Service/Customer/GetCustomerAddressBooks.php
 *
...
#[OA\Get(
    ...
    tags: ['Customer'],
    summary: 'Get customer address book data',
    description: 'Get customer address book data by given Id',
    operationId: 'GetCustomerAddressBooks',
    parameters: [
        new OA\Parameter(
            name: 'Id',
            in: 'path',
...
final class GetCustomerAddressBooks extends BaseService
{
    /**
     * @var CustomerAction
     */
