...
#[OA\Delete(
    ...
    tags: ['Customer'],
    summary: 'Delete single customer status history',
    ...
    responses:[
        ...
        new OA\Response(
            response: 403,
            description: 'customer not found or customer status history not found'
        ),
        new OA\Response(
            response: 500,
            description: 'customer Id required or customer status history Id required'
        ),
    ],
    security: [
        ['modified_auth' => []]
