...
/**
 * /includes/external/api/v1/Service/Customer/DeleteAllStatusHistory.php
 *
...
#[OA\Delete(
    ...
    tags: ['Customer'],
    summary: 'Delete all status history from a customer',
...
final class DeleteAllStatusHistory extends BaseService
{
    /**
     * @var CustomerAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->customerAction->DeleteAllStatusHistory($customerId);
