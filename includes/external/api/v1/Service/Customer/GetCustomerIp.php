...
/**
 * /includes/external/api/v1/Service/Customer/GetCustomerIp.php
 *
...
#[OA\Get(
    ...
    responses: [
        new OA\Response(
            response: 200,
            description: 'customer ip data',
        ),
        new OA\Response(
            response: 403,
            description: 'no customer ip found'
        ),
        new OA\Response(
            response: 500,
    ...
    security: [
        ['modified_auth' => ['GetCustomerIp']]
    ]
)]

final class GetCustomerIp extends BaseService
{
    /**
     * @var CustomerAction
     */
    ...
    public function __invoke(
        ...
        $result = $this->customerAction->GetCustomerIp($customerId);
